...
export default function SignIn() {
    return (
        <div className="h-screen w-screen justify-center flex items-center">
            <div className="w-fit h-fit rounded-xl border-2 flex flex-col column border-[#D9D9D9] mb-32 px-32 py-16">
                ...
                <div className="justify-center flex mt-10 flex-col">
                    <Confirm/>
                    <div className="underline text-sm text-[#4E4E4E] font-semibold text-center mt-2">회원가입 하기</div>
                </div>
            </div>
        </div>
    );
